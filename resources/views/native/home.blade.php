<column ref="welcome-screen" fill center class="safe-area bg-theme-background px-6 py-6">
    <column ref="welcome-card" class="w-full rounded-2xl bg-theme-surface p-10 shadow-md">
        <row ref="nativephp-logo-container" class="w-full justify-center mb-6">
            <image ref="nativephp-logo" src="{{ public_path('images/nativephp-logo.png') }}" alt="NativePHP"
        ...
        <text font="lobster" ref="welcome-subtitle" class="mt-2 mb-8 text-center text-theme-on-surface-variant">
            Your app is ready here. <br />
            <h2 class="text-theme-on-surface-variant">Start building your app!</h2>
            <h2 class="text-theme-on-surface-variant">Start building your app!</h2>
        </text>

        <column class="w-full gap-3">
            <row ref="docs-link" a11y-label="Read the Docs" a11y-hint="Opens the documentation in an in-app browser"
            ...
            <row ref="community-link" a11y-label="Join the Community"
            ...
            <row ref="github-link" a11y-label="Explore on GitHub"
        ...
        <accordion :expanded="$showSpecs" @change="toggleSpecs">
            <accordion-header>
                <text class="text-base font-semibold">Specifications</text>
            </accordion-header>
            <accordion-content>
                <text class="text-sm text-theme-on-surface-variant">Weight — 1.24 kg</text>
                <text class="text-sm text-theme-on-surface-variant">Battery — up to 18 hours</text>
            </accordion-content>
        </accordion>
    </column>
</column>

<native:pressable class="w-full p-4 safe-area" navigate="/service">
    <native:text class="text-red-500">View it</native:text>
</native:pressable>